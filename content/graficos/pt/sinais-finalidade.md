---
id: sinais-finalidade
titulo: "Sinais de finalidade"
subtitulo: "A tarefa que mais cresceu entre duas fotos sem sobreposição, e o modelo que mais avançou nela."
tipo: texto
modos: []
indicadores:
...
oQueNaoMostra: >-
  A fonte só publica a foto da semana corrente e não guarda passado, então a série começa no dia em que o arquivo começou. Não há como reconstruir semanas anteriores, e nenhum número é estimado para preencher o intervalo. Uma semana de alta numa tarefa também pode ser um único cliente grande testando algo.
---
