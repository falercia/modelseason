...
- **Pauta sem notícia repetida**: a coleta olha 30 horas e roda a cada 24, então matéria da véspera voltava. Agora link já publicado nas últimas 10 pautas sai antes da IA, e o agrupamento recebe os títulos já publicados e marca o assunto que é o mesmo fato sem desdobramento novo, que vai para os descartados do PR com a data em que saiu.
- **Notícia × dado**: cada assunto da pauta vira um bloco em duas colunas, a notícia à esquerda (o título abre a matéria original) e, à direita, o painel "O que o dado diz" com share de tokens, share de gasto e o modelo mais usado de cada laboratório citado, com link para a página dele. Nas mudanças do dado, o título deixou de abrir a página do modelo; o link agora é explícito ("Ver … no Model Season").
- **Radar**: o cartão de destaque usava a classe `top`, a mesma do cabeçalho fixo, e grudava no alto da página por cima do topo. Renomeado para `rd-destaque`, com checagem no e2e. Frases de preço mais curtas, com casas decimais iguais nos dois lados da variação e data sem o ano; títulos sem sublinhado fixo e o quadro "O que o dado diz" mais leve nos cartões menores.
